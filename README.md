About jupyterlab_autoversion-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab_autoversion-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab_autoversion-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab_autoversion
# for installing globally
pixi global install jupyterlab_autoversion
```
...
It is possible to list all of the versions of `jupyterlab_autoversion` available on your platform:
...
```
pixi search jupyterlab_autoversion --channel conda-forge
```
